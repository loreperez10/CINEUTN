...
namespace Web.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public PeliculasController(CineUTNContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        {
            var cineUTNContext = _context.Peliculas.Include(p => p.Genero).Include(p => p.Subtitulo).Include(p => p.Tipo);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SubtituloRefId"] = new SelectList(_context.Subtitulos, "Id", "Id");
            ViewData["TipoRefId"] = new SelectList(_context.Tipos, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create(PeliculaViewModels model)
        {
        ...
        private string UploadedFile(PeliculaViewModels model)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            PeliculaViewModels peliculaViewModel = new PeliculaViewModels()
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, PeliculaViewModels model)
        {
